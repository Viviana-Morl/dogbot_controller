...
public:
  DogbotKinematicModel () : KinematicModel(4)
  {
   ...
   /* const double x_nominal_b_lf = 0.18656;
    ...
    max_dev_from_nominal_ << 0.1, 0.15, 0.07;
  }
};
